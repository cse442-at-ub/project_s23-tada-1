...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['Save_Changes'])) {
        ...
        $statement->bind_param('sssssssssss', $_POST["Day"], $_POST["Time"], $_POST["Type"], $_POST["Class"], $_POST["Description"], $username, $event["Day"], $event["Time"], $event["Event Type"], $event["Class"], $event["Description"]);
        ...
        $statement->bind_param('ssssss', $username, $_POST["Day"], $_POST["Time"], $_POST["Type"], $_POST["Class"], $_POST["Description"]);
